...
/* Topics that produce a word problem — prose shown in modal, canvas left blank for student */
...
function closeOverlay() {
  ...
  /* Also close the word problem modal if open */
...
{"eq": "5x - 2 > 7", "answer": "x>9/5", "hint": "Transfer −2 to the right as +2, giving 5x > 9."}`;
  ...
  try {
    ...
    /* ── Word problem modal: populate & show/hide toggle button ── */
    ...
    /* Store for mountEquation (no longer written to canvas — just kept for reference) */
