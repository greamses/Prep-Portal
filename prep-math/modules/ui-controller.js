...
<div id="pp-modal-overlay" class="pp-modal-overlay" role="dialog" aria-modal="true" style="display:none">
    <div class="pp-modal-box" id="pp-modal-box">
        <div class="pp-modal-hd">
            <span id="pp-modal-icon" class="pp-modal-icon"></span>
...
export function initUI(TOPICS_BY_CLASS, onTopicSelect) {
  // Custom dropdown
  ...
  document.querySelectorAll('.cdd-option').forEach(opt => {
    opt.addEventListener('click', () => {
      const classId = opt.dataset.value;
      if (valueDisplay) valueDisplay.innerText = opt.innerText;
      ...
      document.querySelectorAll('.topic-chip').forEach(chip => {
        chip.addEventListener('click', () => {
          ...
          onTopicSelect(classId, chip.dataset.topic);
        });
      });
      
      onTopicSelect(classId, null);
    });
  });
