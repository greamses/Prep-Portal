...
function openOverlay(data) {
    ...
    if (data.type === 'word') {
        // Populate the modal and show the Problem button
        ...
        // Equation mode — hide word problem button + ensure modal is closed
...
// Restore canvas to visible state (called on new question / close)
